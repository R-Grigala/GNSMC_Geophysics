                ...
                data.forEach(data => {
                    ...
                    const row = `
                        <tr data-geophysicLogging-id="${data.id}">
                            ...
                            <td>
                                <img src="/static/img/edit_icon.png" style="width: 30px; height: 30px; cursor: pointer;" alt="Edit" onclick="openGeophysicLoggingModal(true, ${data.id})">
                            </td>
                            <td>
                                <img src="/static/img/trash_icon.png" style="width: 30px; height: 30px; cursor: pointer;" alt="Delete" onclick="deleteGeophysicLogging(${data.id})">
                            </td>
                        </tr>
                    `;
