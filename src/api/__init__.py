...
from src.api.geophysic.geophysic_electrical import GeophysicElectricalListAPI
from src.api.geophysic.geophysic_georadar import GeophysicGeoradarListAPI